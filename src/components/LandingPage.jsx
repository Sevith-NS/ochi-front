...
function LandingPage() {
    ...
    return (
        ...
        <div data-scroll data-scroll-section data-scroll-speed="-.3" className='w-full h-screen bg-zinc-900 pt-1'>
                    ...
                    return (
                            <div key="" className='masker' >
                                <div className='w-fit flex'>
                                    ...
                                    <h1 className='flex items-center uppercase text-[7vw] leading-[7vw]  font-grotesk font-bold'>
                                        {item}
                                    </h1>
                                </div>
                            </div>
            ...
            <div className='border-t-[1px] border-zinc-700 mt-20 flex justify-between font-neue items-center py-5 px-20'>
                {["For Public and Private companies", "From the first Pitch to IPO"].map((item, index) => (
                    <p key={index} className='text-md font-light tracking-tight leading-none'>{item}</p>

                ))}
                <div className='start flex items-center gap-5 '>
                    <div className='px-5 py-2 border-[1px] rounded-full border-zinc-500 font-light text-md uppercase font-neue'>Start the project</div>

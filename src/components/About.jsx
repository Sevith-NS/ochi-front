...
function About() {
  return (
    <div className='w-full p-20 rounded-tl-3xl rounded-tr-3xl bg-[#CDEA68] text-black'>
        <h1 className="font-neue text-[3vw] leading-[3.5vw] tracking-tight ">
        ...
        <div className='w-full flex gap-5 border-t-[1px] pt-10 mt-20 border-[#a1b562]'>
            <div className='w-1/2' >
                <h1 className='text-7xl font-neue'>Our Approach</h1>
                <button className='uppercase px-10 py-6 bg-zinc-900 rounded-full mt-10  text-white font-neue flex gap-7 items-center'>Read More
